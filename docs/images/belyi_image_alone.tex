...
\begin{document}
    ...
    \begin{tikzpicture}[scale=.36]
      ...
      % sheet 1
      \draw[red, thick, fill=red!5!white] (0,9) to[out=0,in=-180] (4,10.5) to[out=0,in=-180] (8,9) -- (14,9) -- (17,15) -- (3,15) -- cycle;
      \draw[red, thin] (10,9) -- (10,11);
      \draw[black, thin] (10,11) -- (10,13.5);
      % sheet 2
      \draw[blue, thick, fill=blue!5!white] (0,12) to[out=0,in=-180] (4,10.5) to[out=0,in=-180] (10,13.5) to[out=0,in=-180] (14,12) -- (17,18) -- (3,18) -- cycle;
      \draw[blue, ultra thin, dashed] (4,10.5)--(6,15);
      \draw[<-, black, thin] (4,3) -- (4,15);
      % sheet 3
      \draw[gray, thick, fill=gray!5!white] (0, 15) -- (6,15) to[out=0,in=-180] (10,13.5) to[out=0,in=-180] (14,15) -- (17,21) -- (3,21) -- cycle;
